...
function uploadToCloudinary(buffer, folder, resourceType, originalFilename) {
        ...
        if (item.rows.length > 0) {
            ...
            for (const url of urls) {
                try {
                    ...
                    console.error('Ошибка удаления из Cloudinary:', err.message);
                }
            }
        }
